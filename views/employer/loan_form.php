        ...
        <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md-8">
                ...
                <div class="mt-3 text-secondary small fw-medium" style="letter-spacing: 0.2px;">
                    ...
                    Distance to Hyperplane: <span class="text-dark"><?= round($result['decision_score'],3)?></span>
                </div>
            </div>

            <div class="col-md-2 mt-3 mt-md-0 text-center text-md-end">
                <button class="btn btn-link text-decoration-none p-0 border-0 bg-transparent inline-flex flex-column align-items-center" 
                        style="color: #ea4335; cursor: pointer;"
                        onclick='alert("You have reported a discrepancy between the model prediction and the actual credit risk. This feedback will be used to improve the SVM algorithm accuracy in the next training cycle.");'>
                    <span class="fw-light line-height-1" style="font-size: 3rem; display: block; margin-bottom: -5px; transform: scaleY(0.9); font-family: sans-serif;">✕</span>
                    <span class="fw-bold d-block text-center mx-auto" style="font-size: 0.8rem; max-width: 100px; line-height: 1.2;">
                        Report Model Error
                    </span>
                </button>
            </div>
